...
public class ParamCheck {
   ...
   public static boolean checkLastName(String lastName)
    ...
    {
         if(checkUserName(user.getUserName()) && checkFirstName(user.getFirstName()) && checkLastName(user.getLastName()) && checkMobileNumber(user.getMobileNumber()) && checkEmailID(user.getEmailID()))
         {
